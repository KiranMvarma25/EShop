            ...
            {(isSidebarOpen || !isMobile) && (
                <div className={`sidebar2 ${isMobile ? "sidebarModal" : ""}`}>
                    <div className="sidebarItems">
                        ...
                        <Link to={"transactions"} className="sidebarItem"><GrTransaction /> Transaction</Link>
                        <Link to={"task"} className="sidebarItem"><BiTask /> Task</Link>
                        <Link to={"activity"} className="sidebarItem"><FiActivity /> Activity</Link>
                        <Link to={"documents"} className="sidebarItem"><IoDocumentSharp /> Documents</Link>
                        <Link to={"notifications"} className="sidebarItem"><IoIosNotifications /> Notifications</Link>
                        <Link to={"profile"} className="sidebarItem"><FaUserAlt /> Profile</Link>
                    </div>
                    <div className="sidebarItems">
